...
# ----------------- Path Parameters -----------------
@app.get("/users/me", tags=["Users"], description="Get the current user")
async def read_user_me():
    return {"user_id": "the current user"}


@app.get("/users/{user_id}", tags=["Users"], description="Get a specific user")
...
@app.get("/models/{model_name}", tags=["Models"], description="Get a specific LLM model")
...
@app.get("/items/{item_id}", tags=["Items"], description="Get a specific item")
...
@app.get("/users/{user_id}/items/{item_id}", tags=["Items"], description="Get a specific item for a user")
...
@app.post("/items/", tags=["Items"], description="Create an item")
async def create_item(item: Item):
    return item

@app.put("/items/{item_id}", tags=["Items"], description="Update an item")
